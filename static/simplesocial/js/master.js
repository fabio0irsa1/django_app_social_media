...
var colors = [];
/* Solar Radidation - https://www.schemecolor.com/solar-radiation.php*/
colors[2] = [];
colors[2]['background'] = '#0d0d2a';
colors[2][1] = 'rgba(106, 188, 98,';
colors[2][2] = 'rgba(248, 215, 71,';
colors[2][3] = 'rgba(243, 102, 51,';
colors[2][4] = 'rgba(127, 17, 20,';
